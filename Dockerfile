...
RUN git clone --depth=1 --recursive --shallow-submodules {{ GIT_FREEDESKTOP }}/libxcb-wm.git \
	&& cd libxcb-wm \
	&& ./autogen.sh --enable-static \
	&& make -j$(nproc) \
...
RUN git clone --depth=1 --recursive --shallow-submodules https://github.com/rzlamrr/libxcb-util \
	&& cd libxcb-util \
	&& ./autogen.sh --enable-static \
	&& make -j$(nproc) \
...
RUN git clone --depth=1 --recursive --shallow-submodules https://github.com/rzlamrr/libxcb-image.git \
	&& cd libxcb-image \
	&& ./autogen.sh --enable-static \
	&& make -j$(nproc) \
...
RUN git clone --depth=1 --recursive --shallow-submodules https://github.com/rzlamrr/libxcb-keysyms.git \
	&& cd libxcb-keysyms \
	&& ./autogen.sh --enable-static \
	&& make -j$(nproc) \
...
RUN git clone --depth=1 --recursive --shallow-submodules https://github.com/rzlamrr/libxcb-render-util.git \
...
RUN git clone --depth=1 --recursive --shallow-submodules https://github.com/rzlamrr/libxcb-cursor.git \
	&& cd libxcb-cursor \
	&& ./autogen.sh --enable-static \
	&& make -j$(nproc) \
